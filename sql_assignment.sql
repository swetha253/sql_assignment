...
select customer.c_name,customer.city as c_city,customer.grade,salesman.salesman_id ,salesman.city as s_city from customer join salesman on customer.salesman_id=salesman.salesman_id
where customer.grade<100 order by customer.cus_id ASC;
